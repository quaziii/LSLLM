 ...
 */
public class SOARoundRobinTOScale_SetCover {
    ...
    private static boolean processarMatch(String pathLog, String arquivo, int map) {
        ...
        RoundRobinTOScaleTIAMAT_SetCover control = new RoundRobinTOScaleTIAMAT_SetCover();
        try {
            ...
            Logger.getLogger(SOARoundRobinTOScale_SetCover.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
