 ...
 */
public class SOARoundRobinTODummy {
    ...
    private static boolean processarMatch(String pathLog, String arquivo) {
        ...
        RoundRobinTOMatchDummy control = new RoundRobinTOMatchDummy();
        try {
            ...
            Logger.getLogger(SOARoundRobinTODummy.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
