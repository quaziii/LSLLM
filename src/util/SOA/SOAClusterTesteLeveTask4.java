 ...
 */
public class SOAClusterTesteLeveTask4 {
    ...
    private static boolean processarMatch(String pathLog, String arquivo) {
        ...
        RoundRobinClusterLeveTask4 control = new RoundRobinClusterLeveTask4();
        try {
            ...
            Logger.getLogger(SOAClusterTesteLeveTask4.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
