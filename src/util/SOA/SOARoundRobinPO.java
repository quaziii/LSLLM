 ...
 */
public class SOARoundRobinPO {

    public static void main(String args[]) throws Exception {
        String pathSOA = args[0];
        String pathLog = args[1];
        //String pathSOA = "/home/rubens/cluster/ExecAIGASOAPartialOb/configSOA/SOA1/";
        //String pathLog = "/home/rubens/cluster/ExecAIGASOAPartialOb/logs/";
    ...
    private static boolean processarMatch(String pathLog, String arquivo) {
        ...
        RoundRobinPOMatch control = new RoundRobinPOMatch();
        try {
            ...
            Logger.getLogger(SOARoundRobinPO.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
