 ...
 */
public class SOAClusterTesteLeve_Cluster_GP {
    ...
    private static boolean processarMatch(String pathLog, String arquivo) {
        ...
        RoundRobinClusterLeve_Cluster_GP control = new RoundRobinClusterLeve_Cluster_GP(pathTableScripts);
        try {
            ...
            Logger.getLogger(SOAClusterTesteLeve_Cluster_GP.class.getName()).log(Level.SEVERE, null, ex);
