 ...
 */
public class SOAClusterTesteLeve_GAB_SAB {
    ...
    private static boolean processarMatch(String pathLog, String arquivo) {
        ...
        RoundRobinClusterLeve_GAB_SAB control = new RoundRobinClusterLeve_GAB_SAB();
        try {
            ...
            Logger.getLogger(SOAClusterTesteLeve_GAB_SAB.class.getName()).log(Level.SEVERE, null, ex);
