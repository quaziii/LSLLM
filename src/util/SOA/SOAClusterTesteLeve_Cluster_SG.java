 ...
 */
public class SOAClusterTesteLeve_Cluster_SG {
    ...
    private static boolean processarMatch(String pathLog, String arquivo) {
        ...
        RoundRobinClusterLeve_Cluster_SG control = new RoundRobinClusterLeve_Cluster_SG(pathTableScripts);
        try {
            ...
            Logger.getLogger(SOAClusterTesteLeve_Cluster_SG.class.getName()).log(Level.SEVERE, null, ex);
