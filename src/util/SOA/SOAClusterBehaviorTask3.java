 ...
 */
public class SOAClusterBehaviorTask3 {
    ...
    private static boolean processarMatch(String pathLog, String arquivo) {
        ...
        RoundRobinClusterBehaviorTask3 control = new RoundRobinClusterBehaviorTask3();
        try {
            ...
            Logger.getLogger(SOAClusterBehaviorTask3.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
